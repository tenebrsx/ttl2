...
import lauraAlbaImage from '../data/laura alba.jpeg';
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white section-padding max-w-5xl mx-auto">
          <h1 className="font-playfair text-6xl md:text-8xl font-bold mb-8 hero-text">
            Aquí es donde
            <br />
            <span className="text-deep-copper">tu historia comienza</span>
          </h1>
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto opacity-90 hero-subtitle leading-loose">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center hero-cta">
            <Link to="/propiedades" className="btn-primary text-lg px-12 py-5">
              Explorar Propiedades
            </Link>
            <Link to="/nosotros" className="btn-secondary bg-white/10 border-white text-white hover:bg-white hover:text-soft-charcoal text-lg px-12 py-5">
              Conocer a Laura
            </Link>
          </div>
        </div>
