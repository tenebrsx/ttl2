...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen pt-20 bg-cream">
      <SEOHead
        title="Contacto - Laura Alba Real Estate | Consulta Personalizada Propiedades de Lujo"
        description="Contacta a Laura Alba para una consulta personalizada sobre propiedades de lujo en República Dominicana. WhatsApp, email y teléfono disponibles. Oficina en Santo Domingo."
        keywords="contacto Laura Alba, consulta propiedades lujo, WhatsApp bienes raíces, oficina Santo Domingo, asesoría inmobiliaria personalizada, cita propiedades RD"
        url="https://fluffy-zabaione-6d8438.netlify.app/contacto"
        structuredData={{
          "@context": "https://schema.org",
          "@type": "ContactPage",
          "name": "Contacto Laura Alba Real Estate",
          "description": "Página de contacto para consultas sobre propiedades de lujo",
          "url": "https://fluffy-zabaione-6d8438.netlify.app/contacto"
        }}
      />
