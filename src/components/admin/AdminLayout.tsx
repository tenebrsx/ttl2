        ...
        <div className="flex flex-col flex-grow bg-white shadow-lg">
          ...
          <div className="border-t border-dusty-clay/20 p-4">
            <div className="flex items-center mb-4">
              <img src={lauraAlba} alt="Laura Alba" className="w-10 h-10 rounded-full mr-3" />
              <div>
                <p className="text-sm font-medium text-soft-charcoal">Laura Alba</p>
                <p className="text-xs text-dusty-clay">{user?.email || 'Administrator'}</p>
              </div>
            </div>
            <button
